...
function NewRecipeForm({addRecipe, updatePostFormData, categories}){
    ...
    return (
        <div className="recipe-add-form">
            <h2 className='header'>Add New Recipe Form</h2>
            ...
            <form onSubmit={event => {
                ...
                <div className= 'recipe-form-container'>
                    <input onChange={updatePostFormData} type="text" className = "title_new_recipe" name="title" placeholder="What's the recipe called?" required/>
                    {/* <FileInput></FileInput> */}
                    ...
                    <textarea onInput = {handleInput} onChange={updatePostFormData} type="text" name="ingredients" className = "ingredients_new_recipe" placeholder="Ingredients" rows = '100' required/>
                    <textarea onInput = {handleInput} onChange={updatePostFormData} type="text" name="preparation" rows = '100' className = "preparation_new_recipe"placeholder="Preparation" required/>                
                    <textarea onChange={updatePostFormData} type="text" name="tips" className = "tips_new_recipe" placeholder="Tips" required/>
